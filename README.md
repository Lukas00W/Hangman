...
Der Spieler errät Buchstaben eines zufällig ausgewählten Wortes. Für jeden falschen Versuch wird ein Teil des Galgens angezeigt.  
Das Spiel endet, wenn das Wort vollständig erraten wurde oder keine Leben mehr übrig sind.
...
- Nutzung von **if / else Bedingungen**
- Verarbeitung von **Benutzereingaben**
- Fehlerprüfung 
- String-Verarbeitung und Ausgabe in der Konsole
- Grundlegende **Programmlogik und Ablaufsteuerung**
...
4. Falsche Buchstaben reduzieren die Anzahl der Leben  
5. Das Spiel endet mit Sieg oder Niederlage  
6. Der Spieler kann entscheiden, ob er erneut spielen möchte  
